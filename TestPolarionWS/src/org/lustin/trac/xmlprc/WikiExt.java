...
public interface WikiExt {
    ...
    Vector    getChildren(String pagename); 	//Returns a list of all pages. The result is an array of utf8 pagenames. 	WIKI_VIEW
    Hashtable getMacros();                      //Return the list of registered wiki macros 	WIKI_VIEW
}
